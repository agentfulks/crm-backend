...
def get_mock_funds(limit: int = 5) -> List[Dict[str, Any]]:
    """Return mock fund data for testing when database is unavailable."""
    mock_funds = [
        {
            "id": "mock-fund-001",
            "name": "Accel Partners",
            "score": 95.5,
            "contact_email": "partner@accel.com",
            "hq_city": "Palo Alto",
            "hq_country": "USA",
            ...
            "overview": "Leading venture capital firm focused on early-stage investments in enterprise software and consumer technology.",
            "contact_name": "John Smith",
            "contact_title": "Partner",
            "contact_email_alt": None,
            "contact_linkedin": "https://linkedin.com/in/johnsmith",
            "primary_email": "partner@accel.com",
        },
        {
            "id": "mock-fund-002",
            "name": "Bessemer Venture Partners",
            "score": 92.0,
            "contact_email": "info@bvp.com",
            ...
            "overview": "Global venture capital firm with deep expertise in cloud computing, cybersecurity, and healthcare technology.",
            "contact_name": "Sarah Chen",
            "contact_title": "Principal",
            "contact_email_alt": None,
            "contact_linkedin": "https://linkedin.com/in/sarahchen",
            "primary_email": "info@bvp.com",
        },
        {
            "id": "mock-fund-003",
            "name": "Greylock Partners",
            "score": 88.5,
            "contact_email": "team@greylock.com",
            "hq_city": "Menlo Park",
            "hq_country": "USA",
            ...
            "overview": "Early-stage venture capital firm backing ambitious founders building category-defining companies.",
            "contact_name": "Michael Park",
            "contact_title": "Partner",
            "contact_email_alt": None,
            "contact_linkedin": "https://linkedin.com/in/mpark",
            "primary_email": "team@greylock.com",
        },
        {
            "id": "mock-fund-004",
            "name": "Andreessen Horowitz",
            "score": 97.0,
            "contact_email": "invest@a16z.com",
            "hq_city": "Menlo Park",
            "hq_country": "USA",
            "check_size_min": 500000,
            ...
            "overview": "Silicon Valley-based venture capital firm known for backing bold entrepreneurs.",
            "contact_name": "Marc Andreessen",
            "contact_title": "Co-founder",
            "contact_email_alt": None,
            "contact_linkedin": "https://linkedin.com/in/pmarca",
            "primary_email": "invest@a16z.com",
        },
        {
            "id": "mock-fund-005",
            "name": "Sequoia Capital",
            "score": 98.5,
            "contact_email": "partners@sequoiacap.com",
            "hq_city": "Menlo Park",
            "hq_country": "USA",
            "check_size_min": 1000000,
            ...
            "check_size_currency": "USD",
            "stage_focus": ["Seed", "Series A", "Series B", "Growth"],
            "overview": "Premier venture capital firm backing founders from idea to IPO.",
            "contact_name": "Roelof Botha",
            "contact_title": "Partner",
            "contact_email_alt": None,
            "contact_linkedin": "https://linkedin.com/in/roelof",
            "primary_email": "partners@sequoiacap.com",
        },
    ]
    return mock_funds[:limit]


def get_top_scored_funds(limit: int = 5, use_mock: bool = False) -> List[Dict[str, Any]]:
    """Query the top N scored funds from the CRM database."""
    if use_mock:
        return get_mock_funds(limit)
...
def run_daily_intake(
    ...
    print(f"Data Source: {'MOCK DATA' if use_mock else 'CRM Database'}")
    ...
    try:
        funds = get_top_scored_funds(limit, use_mock=use_mock)
...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        dest="use_mock",
        help="Use mock data instead of querying the database (for testing)",
    )
    parser.add_argument(
        "--limit",
        type=int,
